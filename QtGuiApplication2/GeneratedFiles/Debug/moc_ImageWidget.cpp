...
QT_MOC_LITERAL(1, 12, 22), // "imageVisibilityClicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "ImageWidget\0imageVisibilityClicked\0"
};
...
void ImageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->imageVisibilityClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageWidget::imageVisibilityClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageWidget::imageVisibilityClicked(int _t1)
{
